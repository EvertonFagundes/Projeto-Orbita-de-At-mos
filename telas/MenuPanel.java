...
public class MenuPanel extends JPanel {
    ...
    // --- Métodos de integração com o MainFrame ---
    public void addHydrogenListener(ActionListener l) {
        getBtnHidro().addActionListener(l);
    }

    public void addHeliumListener(ActionListener l) {
        getBtnHelio().addActionListener(l);
    }
}
